...
function onBanListEvent(serverConnectionHandlerID, banid, ip, name, uid, mytsid, creationTime, durationTime, invokerName, invokercldbid, invokeruid, numberOfEnforcements, lastNickName)
	debugPrint("Lua: onBanListEvent: " .. serverConnectionHandlerID .. " " .. banid .. " " .. ip .. " " .. name .. " " .. uid .. " " .. mytsid .. " " .. creationTime .. " " .. durationTime .. " " .. invokerName .. " " .. invokercldbid .. " " .. invokeruid .. " " .. numberOfEnforcements .. " " .. lastNickName)
	for script,events in pairs(ts3RegisteredModules) do
		if events.onBanListEvent ~= nil then
			events.onBanListEvent(serverConnectionHandlerID, banid, ip, name, uid, mytsid, creationTime, durationTime, invokerName, invokercldbid, invokeruid, numberOfEnforcements, lastNickName)
		end
	end
end
...
function onPluginCommandEvent(serverConnectionHandlerID, pluginName, pluginCommand, invokerClientID, invokerName, invokerUniqueIdentity)
	debugPrint("Lua: onPluginCommandEvent: " .. serverConnectionHandlerID .. " " .. pluginName .. " " .. pluginCommand .. invokerClientID .. " " .. invokerName .. " " .. invokerUniqueIdentity)
	for script,events in pairs(ts3RegisteredModules) do
		if events.onPluginCommandEvent ~= nil then
			events.onPluginCommandEvent(serverConnectionHandlerID, pluginName, pluginCommand, invokerClientID, invokerName, invokerUniqueIdentity)
		end
	end
end
...
ts3.banadd(serverConnectionHandlerID, ipRegExp, nameRegexp, uniqueIdentity, mytsid, timeInSeconds, banReason) > error
ts3.bandel(serverConnectionHandlerID, banID) > error
ts3.bandelall(serverConnectionHandlerID) > error
ts3.requestBanList(serverConnectionHandlerID, start, duration) > error
