...
local function setPluginMenuEnabled(serverConnectionHandlerID, menuID, enabled)
	-- To get the correct menuID, add reportscript_events.moduleMenuItemID to the given menuID (MENU_ID_CLIENT_1 etc.)
	print("setPluginMenuEnabled: " .. menuID .. " " .. enabled .. " mult: " .. reportscript_events.moduleMenuItemID)
	ts3.setPluginMenuEnabled(reportscript_events.moduleMenuItemID + menuID, enabled)
end
